...
@test "Testing lines.d - header" {
    ...
    EARLYHEADER_E=$(get_line "^#line $(($EARLYHEADER_O + 2)) \"parser.h\"" parser.h)
    ...
    EARLYCOMMON_E=$(get_line "^#line $(($EARLYCOMMON_O + 2)) \"parser.h\"" parser.h)
    ...
    HEADER_E=$(get_line "^#line $(($HEADER_O + 2)) \"parser.h\"" parser.h)
    ...
    COMMON_E=$(get_line "^#line $(($COMMON_O + 2)) \"parser.h\"" parser.h)
...
@test "Testing lines.d - source" {
    ...
    EARLYSOURCE_E=$(get_line "^#line $(($EARLYSOURCE_O + 2)) \"parser.c\"" parser.c)
    ...
    EARLYCOMMON_E=$(get_line "^#line $(($EARLYCOMMON_O + 2)) \"parser.c\"" parser.c)
    [ "$EARLYCOMMON_S" -eq $((EARLYCOMMON_O - 1)) ]
    [ "$EARLYCOMMON_E" -eq $((EARLYCOMMON_O + 1)) ]
    ...
    SOURCE_E=$(get_line "^#line $(($SOURCE_O + 2)) \"parser.c\"" parser.c)
    ...
    COMMON_E=$(get_line "^#line $(($COMMON_O + 2)) \"parser.c\"" parser.c)
    [ "$COMMON_S" -eq $((COMMON_O - 1)) ]
    [ "$COMMON_E" -eq $((COMMON_O + 1)) ]
    ...
    RULE1_E=$(get_line "^#line $(($RULE1_O + 2)) \"parser.c\"" parser.c)
    ...
    RULE2_E=$(get_line "^#line $(($RULE2_O + 2)) \"parser.c\"" parser.c)
    ...
    RULE3_E=$(get_line "^#line $(($RULE3_O + 2)) \"parser.c\"" parser.c)
